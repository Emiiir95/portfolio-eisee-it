  ...
  return (
    <div className="bg-[#27272A] w-full p-11 flex gap-10 md:flex-row mt-20 flex-col justify-center items-center">
          <div className="md:w-[30%] md:leading-[38px]">
            <Typography align="center" color="white" variant="componentTitle" animated>À propos de moi</Typography>
            <Typography align="center" color="white" marginClassName="mt-5" customClassName="md:text-left text-center">{description}</Typography>
          </div>
