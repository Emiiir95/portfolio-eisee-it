    ...
    <div>
      ...
      <div className="flex flex-col gap-1 md:flex-row md:items-center md:gap-5">
        <div className="flex w-fit flex-wrap -space-x-2 overflow-hidden p-3 hover:cursor-pointer">
          {techs?.map((tech, index) => (
            ...
            >
              ...
              >
                <Image height={200} width={200} src={tech.pathLogo} alt={tech.titleLogo} className="h-full w-full" />
              </div>
            </div>
          ))}
        </div>
        {hoveredIndex !== null && (
          ...
          >
            <Typography key={techs[hoveredIndex].titleLogo} align="center" variant="h5" weight="bold" color="primary">
