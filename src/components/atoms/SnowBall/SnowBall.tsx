...
export function SnowBall({ avatar,avatar2, name, job }: SnowBallPorps) {
    ...
    return (
    <div className="w-44 h-64 flex flex-col items-center relative overflow-hidden border-[2px] border-[#815CFC] rounded-2xl shadow-inner shadow-white p-4 gap-4" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>  
