...
export function MissionSnowpact() {
  ...
  <div className='relative py-20 h-auto px-10'>
    <img src={fondApple} className='absolute inset-0 w-full h-full object-cover' />

    <div className='relative z-50 flex-col gap-12 items-center justify-center flex'>
      <Typography align='center' variant='componentTitle' animated><span className='text-black'>Mes missions</span></Typography>
      ...
      <aside className="bg-black text-white p-6 rounded-lg w-full max-w-lg font-mono">
        ...
        <div className="mt-4">
          ...
          <p className="text-green-400">$ <span className='animate-pulse animate-infinite animate-duration-1000 text-white'>|</span></p>
        </div>
      </aside>
    </div>
  </div>
