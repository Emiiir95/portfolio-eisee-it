...
import { BookOpenCheckIcon, Code2Icon, DraftingCompassIcon, RocketIcon } from 'lucide-react';
...
<div className="mx-auto max-w-7xl px-6 lg:px-8">
  <div className="mx-auto lg:mx-0">
    <Typography animated customClassName="text-5xl font-semibold tracking-tight sm:text-7xl">Snowpact</Typography>
    <p className="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">
    Leur mission est de vous accompagner dans la conception, le développement et le déploiement de vos applications web et mobile, en utilisant la méthode agile pour garantir la qualité, la flexibilité et la satisfaction de vos besoins.
    </p>
  </div>
  ...
  <div className='w-full gap-20 flex-row flex border-t-[1px] border-b-[1px] py-12 px-52 border-[#232323] backdrop-blur-sm bg-opacity-30 bg-[#000000]'>
      <Typography marginClassName='mt-42' variant='h1' animated align='left'>Quelques <span className='text-[#E12CF7]'>réalisations</span></Typography>
