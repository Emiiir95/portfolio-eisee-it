  ...
  const data = [
      ...
      content: (
        <div>
          <Typography variant="h1" animated>
            Mon BTS à l&apos;Esiee It
          </Typography>
          <Typography customClassName="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Quelques aperçus de mes projets en école
          </Typography>
    ...
    },
    {
      ...
      content: (
        <div>
          <Typography variant="h1" animated>
            Mon alternance chez Snowpact
          </Typography>
          <Typography customClassName="text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Quelques aperçus de mes projets en entreprise
          </Typography>
          <div className="grid grid-cols-2 gap-4">
            <img
              src={snowpact}
