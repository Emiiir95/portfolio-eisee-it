...
export const ProjetBlock = ({label}: ProjetBlockInteface) => {
  ...
  const projectsProfessionnel = [
    {
      ...
      year: '2024',
      description: "Entreprise de construction et de rénovation de façades et l'isolation thermique.",
      publicLabel: 'Propriétaires de biens immobiliers et entreprises de construction/rénovation',
      missionLabel: "En charge de la migration du site vers WordPress, en veillant à conserver les fonctionnalités existantes tout en simplifiant la gestion des contenus pour le client.",
    ...
    },
    {
      ...
      missionLabel: "Développement du nouveau design pour améliorer l'expérience utilisateur, ainsi qu'une application mobile permettant de signaler des incidents en temps réel.",
    ...
    },
    {
      ...
      year: '2023-2024',
      description: 'Application qui référence les restaurant halal en France et qui permet de garantir la qualité des restaurants lister dans le site.',
      publicLabel: 'Les restaurateurs / Les consommateurs',
      missionLabel: "Correction de divers bugs impactant le front du site et l'application mobile, ce qui a permis de stabiliser et d'optimiser les performances.",
    ...
    },
    {
      ...
      link: 'snowpact.com',
      year: '2024',
      description: "Agence spécialisée dans le développement web sur mesure, offrant des services comme la création de sites internet, d'applications web et mobile.",
    ...
    },
    {
      ...
      publicLabel: "ADN",
      missionLabel: 'Migration du cron anciennement développé en PHP, en TypeScript en suivant une Clean Architecture, pour améliorer la maintenabilité et la performance du système.',
    ...
    },
    {
      ...
      link: 'evolios.fr',
      year: '2024',
      description: "Evolios est une application back-office dédiée aux entreprises du secteur du bâtiment. Elle permet une gestion simplifiée des dépenses, des achats de matériaux, et du suivi des stocks.",
      publicLabel: "Entreprises du bâtiment / Evolios",
      missionLabel: "Développement d'un back-office complet pour permettre une gestion optimisée des données et des fonctionnalités.",
      technoLabel: 'npm, react, tailwind',
      tools: 'Slack, Github, VScode',
      image: evoliosIcon,
    },
    {
      ...
      year: '2023',
      description: "MySocialWorker est une plateforme numérique qui facilite les démarches administratives pour les bénéficiaires d'aides sociales et les travailleurs sociaux.",
      publicLabel: "Bénéficiaires sociaux et travailleurs sociaux",
      missionLabel: "Conception et développement front du site, en mettant l'accent sur une interface intuitive et adaptée aux besoins des utilisateurs.",
      technoLabel: 'npm, next, tailwind',
  ...
  const handleSwitchChange = () => {
    setActiveSection((prev) => (prev === 'professionnel' ? 'scolaire' : 'professionnel'));
  };

 
  return (
    <div className="flex items-center flex-col">
      <Typography variant="heroTitle" color="white" customClassName="md:pb-20 pb-10">
        {label}
      </Typography>
      <div className="w-full shadow-div flex-col flex rounded-3xl md:py-5 p-12 md:px-32 bg-[#27272A] border-2 border-[#27272A] bg-opacity-30 relative md:items-start md:justify-start items-center justify-center">
        <div className="flex justify-center items-center md:justify-start md:items-start h-12 pt-12 rounded-2xl w-auto gap-6 mb-24 md:flex-row flex-col">
          <Typography variant="h2" customClassName={activeSection === 'professionnel' ? 'text-orange-500' : 'text-gray-500'}>Professionnel</Typography>
          <Switch checked={activeSection === 'scolaire'} onChange={handleSwitchChange} />
          <Typography variant="h3" customClassName={activeSection === 'scolaire' ? 'text-orange-500' : 'text-gray-500'}>Scolaire</Typography>
        </div>
