...
import signaleoWebFigma from "@/assets/images/projet/entreprise/signaleoWeb/figma.webp";
import signaleoWebLinear from "@/assets/images/projet/entreprise/signaleoWeb/linear.webp";
import signaleoMobileApercu from "@/assets/images/projet/entreprise/signaleoMobile/interface.webp";
import signaleoMobileGithub from "@/assets/images/projet/entreprise/signaleoMobile/github.webp";
import signaleoMobileSlack from "@/assets/images/projet/entreprise/signaleoMobile/slack.webp";
...
export const realisationsScolaires = [
  {
    url: "joticket",
    title: "JO Tickets",
    link: "github.com/esiee-it-slam-2025/sen_emir/tree/main/ProjetJoTicket",
    year: "2024-2025",
    description:
    ...
    platforms: [
      ...
      { name: "Admin", image: joAdmin },
      { name: "Github", image: joGithub },
      { name: "BDD", image: joBdd },
    ],
    stats: [
  ...
  },
  {
    url: "treiinquille",
    title: "Treiinquille",
    link: "github.com/Semiiih/Treiinquille",
    year: "2024-2025",
    description:
    ...
    platforms: [
      { name: "Figma", image: treiinFigma },
      { name: "Github", image: treiinGithub },
      { name: "Gantt", image: treiinGantt },
    ],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
    ...
    document: [
      {
        ...
        download: treiinDiagrammeUtilisation,
      },
      { name: "Cahier Technique", download: treiinCahier },
      { name: "Maquette", download: treiinMaquette },
  ...
  },
  {
    url: "gestionepi",
    title: "Geston Epi",
    link: "github.com/Emiiir95/GestionEPI",
    year: "2024-2025",
    description:
    ...
    image: gestepiIcon,
    platforms: [
      { name: "Présentation", image: epiFront },
      { name: "Application", image: epiDashboard },
      { name: "Clerk", image: epiClerk },
      { name: "BDD", image: epiBdd },
      { name: "Postman", image: epiPostman },
      { name: "Github", image: epiGithub },
    ],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
  ...
  {
    url: "gestionentretien",
    title: "Gestion Entretien",
    link: "github.com/Emiiir95/GestionEntretiens",
    year: "2024",
    description:
    ...
    platforms: [
      { name: "Postman", image: entretienPostman },
      { name: "BDD", image: entretienBdd },
      { name: "Github", image: entretienGithub },
    ],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
  ...
  },
  {
    url: "portfolio",
    title: "Portfolio",
    link: "portfolio-emir-sen.vercel.app/",
    year: "2024-2025",
    description:
    ...
    image: portfolioIcon,
    platforms: [
      { name: "Aperçu", image: portfolioApercu },
      { name: "Github", image: portfolioGithub },
      { name: "Vercel", image: portfolioVercel },
      { name: "Google Alerts", image: portfolioAlert },
    ],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
  ...
  },
  {
    url: "easytrain",
    title: "Easytrain",
    link: "github.com/Emiiir95/JAVA_SEN",
    year: "2024-2025",
    description:
    ...
    image: easytrainIcon,
    platforms: [
      { name: "Github", image: easytrainGithub },
      { name: "BDD", image: easytrainBdd },
    ],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
  ...
  {
    url: "les4fantastiques",
    title: "Les 4 Fantastiques",
    link: "github.com/Semiiih/Les4Fantastiques",
    year: "2024",
    description:
    ...
    platforms: [
      { name: "Linear", image: fantastiquePlanning },
      { name: "Ticket", image: fantastiqueTicket },
      { name: "Discord", image: fantastiqueDiscord },
      { name: "Github", image: fantastiqueGithub },
    ],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
    ...
    document: [
      { name: "Cahier des Charges", download: fantastiqueCharge },
      { name: "Charte Graphique", download: fantastiqueCharte },
      {
        name: "Diagramme de base de donnée",
        download: fantastiqueDiagrammeBdd,
      },
    ],
    dataPage: [
      // {
  ...
  },
  {
    url: "journal",
    title: "Journal",
    link: "github.com/esiee-it-slam-2025/sen_emir/tree/main/exercices",
    year: "2024",
    description:
  ...
  },
  {
    ...
    image: heritageIcon,
    platforms: [{ name: "Github", image: heritageGithub }],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
      { id: 3, name: "Pages", value: "14" },
  ...
  },
  {
    ...
    technoLabel: "C#",
    tools: "Github, Visual Studio",
    image: gestionpiloteIcon,
    platforms: [{ name: "Github", image: piloteGithub }],
    stats: [
      { id: 1, name: "Commit", value: "800" },
      { id: 2, name: "Composants developper", value: "30" },
      { id: 3, name: "Pages", value: "14" },
